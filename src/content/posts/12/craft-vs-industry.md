---
date: 2023-03-05
title: "Separation of Concerns: Craft and Industry in Websitemaking"
...
A single difference that allows us to sort something into a dichotomy - that is what a "Leitdifferenz" refers to (I am using the German word directly here, to refer to Niklas Luhmann's concept, because I cannot find a semantically fitting translation). We have been obsessed with this difference, that will tell us how well something will adapt with the changing requirements of an organisation and increasing, diverse technical demand. But for businesses, scaling means that output remains or only slightly degrades, while production costs lower.

A course is a scaling product. Because you are investing time into its production and then all you have to do is maybe every now and then generate a promotional advertisement for it, but the price remains the same, while your initial expense disappears entirely. Your margin has increased - your product has scaled. This is the purpose of industry in general. Create a "streamlined" (another term that we have gotten very familiar with) manufacturing process, automate it as much as possible, to generate a product that will sell to as many consumers as possible.

Our industry for the most part is still considered a manufacturing industry, because it still requires manual labour ("manu factum" means "made by hand") at some ends, but these are already also becoming subject to automation.

This is also how we're approaching, and selling, design systems - it is "Design at scale". We can see this reflected in how the dominant design tool, Figma is adjusting their feature set to accommodate processes that are only relevant in very large, distributed design teams: Branching, dedicated organisation plans that include features such as SSO, Design System Analytics (wtf), branching & merging, etc. Even [Brad Frost, the inventor of atomic design, agrees](https://bradfrost.com/blog/post/design-systems-agile-and-industrialization/). In the words of [Jeremy Keith](https://adactio.com/journal/16369):
...
Design has, in my opinion, degraded massively over the years - not for companies! For the industry, it looks like it was finally embraced as an integral part of the process. But I believe at very, _very_ large costs.
...
This change in demographic of who write code has made it easier to hire for these positions. A website that is entirely rendered in JavaScript can be worked on by someone with a University Degree, in which they rarely learn the special relationship between HTML, CSS and JavaScript but instead are being told that CSS and HTML are not real programming languages. And with these capital P Programmers come their language and their world view.

## Craftsperson vs Factory worker

Those who work on the web are often required to navigate conflicts between what they've experienced to be the best solution to a problem in their identity as a person who makes websites and what they are expected to do in their identity as a person working in this industry. If it went according to industry, all of our websites should be in react, but alas that is nowhere near the reality. Yet people see themselves forced to work with these technologies, because the only see job postings requiring them to be experienced in it.

This is a conflict between two identities: The craftsperson and the factory worker. The craftsperson wants to do what is dictated by the values of the craft, but the factory worker needs to do what will keep them employed or employable.

### Separating Concerns

Luckily, our platform operates on a philosophical principle that we can apply here as well: Separation of Concerns. If we separate the demand into independent concerns, made by independent parties, we get the chance to instead of having to decide, to hold the ambivalence and the complexity of the situation. Industry of course would force us to reduce complexity, another religious mantra of Programming.

Holding both positions does not change them, but it may allows to not experience them in conflict with each other. If we understand them as a conflict of concerns and not a conflict of identity, we may even see where both concerns even align. Or we can give voices to both parts. At the very least, it may help us to not experience this as a personal conflict, but instead leave it to the job, which has to find a way to utilise craft in a way that makes it compatible enough with industrial processes - another different concern reveals itself here, the concern of the business, not the concern of the employee.

## Failing to conciliate competing Identities

This isn't always possible though. And sometimes, people may decide to leave this industry all together - to protect themselves from this conflict. Not because they couldn't hold it as is, but because they don't want to degrade themselves or their view of the craft.
...
Many people are not differentiating here, and so they just repeat the capitalist programmers mantras. But that says much more about how they relate to and how they define themselves. Do they even consider themselves as craftspeople? Do they even _see_ the craft that is there? Truly not my problem.
...
In order to protect ourselves from this inevitable reality (again, programming was invented to make human labour in weaving redundant; This is the Leitdifferenz of the entire profession.), we can learn to understand employability does not make us craftspeople.
